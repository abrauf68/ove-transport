...
@section('breadcrumb-items')
    ...
    <li class="breadcrumb-item"><a href="{{ route('dashboard.car-models.index', $carBrand->id) }}">{{ __('Car Models') }}</a></li>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card mb-6">
            ...
            <div class="card-body pt-4">
                <form method="POST" action="{{ route('dashboard.car-models.store', $carBrand->id) }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row p-5">
                        <h3>{{ __('Add New Car Model') }}</h3>
                    ...
                    <div class="mt-2">
                        <button type="submit" class="btn btn-primary me-3">{{ __('Add Car Model') }}</button>
                    </div>
                </form>
            </div>
            <!-- /Account -->
