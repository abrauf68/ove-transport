...
<section id="testimonials" class="testimonials section dark-background">
    ...
    {!! \App\Helpers\Helper::optimizeImage('frontAssets/img/testimonials-bg.jpg', 'Testimonials Background', 'testimonials-bg') !!}
                ...
                @foreach (\App\Helpers\Helper::getTestimonials() as $testimonial)
                    <div class="swiper-slide">
                        <div class="testimonial-item">
                            {!! \App\Helpers\Helper::optimizeImage('{{ $testimonial->image }}', '{{ $testimonial->name }}', 'testimonial-img') !!}
